    ...
    <>
      <div
        className={`rounded-2xl border transition-all overflow-hidden shadow-xs max-w-full min-w-0 ${
          isPositive
            ? "bg-gradient-to-br from-[var(--teal-soft)]/50 via-white to-[var(--surface-bg)] border-[var(--teal)]/40"
            : "bg-gradient-to-br from-amber-50/60 via-white to-[var(--surface-bg)] border-amber-300"
        } ${className}`}
      >
        {/* Header Strip */}
        <div
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {hasAnyHistory && (
              <button
                ...
                className="px-2.5 py-1 rounded-lg text-[11.5px] font-bold bg-white text-[var(--navy)] hover:bg-[var(--navy-50)] border border-[var(--navy)]/20 flex items-center gap-1 cursor-pointer transition-all shadow-2xs"
                title="Xem chi tiết lịch sử khám chữa bệnh và các lần kiểm tra thẻ"
              >
                <History className="w-3.5 h-3.5 text-[var(--teal-deep)]" />
        ...
        {/* Card Body */}
        <div className="p-3.5 text-[12.5px] text-[var(--ink)] space-y-2 font-sans min-w-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-2 min-w-0">
            <div className="min-w-0">
              ...
              <strong className="font-mono text-[13.5px] text-[var(--navy-deep)] tracking-wider truncate block">
                {the.maThe}
              </strong>
            </div>
            ...
            <div className="min-w-0">
              ...
              <strong className="text-[13px] uppercase text-[var(--ink)] truncate block">
            ...
            <div className="min-w-0">
              ...
              <strong className="font-mono text-[12.5px] text-[var(--teal-deep)] block">
            ...
            <div className="sm:col-span-2 min-w-0">
              ...
              <strong className="text-[12.5px] text-[var(--ink)] flex items-center gap-1.5 min-w-0" title={the.tenDKBD || ""}>
            ...
            {the.namNamLienTuc && (
              <div className="min-w-0">
                ...
                <span className="font-mono font-bold text-[var(--teal-deep)] text-[12px]">
                  ✨ {the.namNamLienTuc}
                </span>
              </div>
            )}
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-[13px] font-bold transition-all flex items-center gap-2 cursor-pointer ${
                  activeTab === "kcb"
                    ...
                    : "bg-white text-[var(--mute)] hover:text-[var(--ink)] border border-[var(--line)]"
                }`}
              >

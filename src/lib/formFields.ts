...
export const FIELD_GROUPS: FieldGroup[] = [
  {
    ...
    fields: [
      ...
      { key: "mucHuongBHYT", label: "Mức hưởng BHYT", type: "number", hint: "% hưởng: 100 / 95 / 80" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "xacNhanDieuTri", label: "Xác nhận điều trị", type: "boolean", hint: "CÓ / KHÔNG — tự động đồng bộ theo Nhóm A/B" },
      { key: "ngayDieuTri", label: "Ngày điều trị dự kiến", type: "date", alwaysOn: true, hint: "Nhập ở màn Tư vấn & phân nhóm (BR-04)" },
